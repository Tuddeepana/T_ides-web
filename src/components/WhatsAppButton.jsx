const WhatsAppButton = () => {
  const phoneNumber = "941716520690"
  const message = "Hi! I'm interested in booking a safari with Tides Yala Safari. Could you please provide me with more information?"
  ...
  return (
    <div className="fixed bottom-6 left-6 z-40">
      ...
      {/* Pulse animation */}
      <div className="absolute inset-0 w-14 h-14 bg-green-400 rounded-full animate-ping opacity-20"></div>
    </div>
  )
}
